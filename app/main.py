...
async def root():
    return {
        ...
        'status': 'running',
        'version': '1.0.0',
        'endpoints': ['/stats/{camera_id}', '/detect', '/generate-report', '/ws/alerts']
    }

# IMPORTANT: This endpoint was missing - adding it now
...
async def verify_token():
    """Verify authentication - Allow all for demo"""
    return JSONResponse({
        "valid": True, 
...
async def get_cameras():
    ...
    return JSONResponse({"cameras": [
        {"id": "camera1", "name": "Main Gate", "status": "active", "url": "rtsp://localhost:8554/camera1"},
        {"id": "camera2", "name": "Exit Gate", "status": "active", "url": "rtsp://localhost:8554/camera2"}
    ]})
